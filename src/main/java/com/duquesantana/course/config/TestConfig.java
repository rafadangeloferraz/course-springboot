...
import com.duquesantana.course.entities.Payment;
...
import com.duquesantana.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner { //CommandLineRunner executa qdo pgm for iniciado
	...
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1);//para salvar obj dependete numa rel 1 para 1, faz assoc e mao dupla em memoria
